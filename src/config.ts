...
export const config: Config = {
  /** Grid resolution in CSS pixels. viewport size / this = dot/cell count per axis. Default: 10 */
  dotSpacingPx: 10,
  /** Per-step energy retention. 0.99 = long-lived waves, 0.95 = syrupy. Default: 0.983 */
  damping: 0.983,
  /** Click disturbance radius, in grid cells. Default: 5 */
  clickRadius: 5,
  /** Click disturbance peak strength. Default: 100 */
  clickStrength: 100,
  /** Drag-stamp radius, in grid cells — smaller than a click so wakes read as a trail. Default: 1 */
  dragRadius: 1,
  /** Drag strength scales with pointer speed (px/frame) by this factor. Default: 3 */
  dragStrengthPerPxOfSpeed: 3,
  /** Hard clamp on drag strength so a fast flick can't blow out the heightfield. Default: 400 */
  dragStrengthMax: 400,
